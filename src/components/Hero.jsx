        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-0">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-4">
            ...
            >
              ...
              {/* CTA buttons */}
              <motion.div variants={fadeUp} className="mb-8 flex flex-wrap items-center gap-3 justify-center lg:justify-start">
                <a
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 rounded-xl border-2 border-gray-200 bg-white px-6 py-3.5 text-gray-800 shadow-sm hover:shadow-md hover:border-pink-300 transition-all duration-300 hover:scale-105 active:scale-95"
                >
